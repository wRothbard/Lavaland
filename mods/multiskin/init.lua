...
local default_skin = "player_male.png"
local default_format = "1.0"
local player_skins = {}
local player_format = {}
...
multiskin.update_player_visuals = function(player)
	...
	if anim.model == "character.b3d" then
		player_api.set_model(player, multiskin.model)
	...
	player_api.set_textures(player, table.copy(textures))
end

player_api.register_model("multiskin.b3d", {
	animation_speed = 30,
	textures = {
		"blank.png",
		"blank.png",
