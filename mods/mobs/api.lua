...
--		print ("standing in " .. self.standing_in)
	...
	if undercrowd(pos, 32) > 3 then
		--log("on_step: Undercrowd is greater than three in a 32 radius area, returning.")
		return
	end

	if minetest.find_node_near(pos, 8, "mobs:spawner") then
		--log("on_step: Found nearby spawner, breaking.")
		return
	end
	...
	node_name = node.name
	if node_name ~= "air" then
		--log("on_step: No air found for spawner insertion, returning.")
		return
	end
