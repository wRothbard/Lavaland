...
minetest.register_entity("boats:boat_wood", boat)
minetest.register_craftitem("boats:boat_wood", {
	description = "Boat",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local b = minetest.add_entity(pointed_thing.under, "boats:boat_wood")
		if b then
			if placer then
				b:set_yaw(placer:get_look_horizontal())
			end
...
minetest.register_craftitem("boats:boat_mese", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		pointed_thing.under.y = pointed_thing.under.y + 0.5
		local b = minetest.add_entity(pointed_thing.under, "boats:boat_mese")
		if b then
			if placer then
				b:set_yaw(placer:get_look_horizontal())
			end
